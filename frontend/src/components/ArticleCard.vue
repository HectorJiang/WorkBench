        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../assets/img/demo1.jpg" class="d-block w-100" data-interval="2000" alt="..." style="height: 224px; cursor:pointer">
                </div>
                <div class="carousel-item">
                    <img src="../assets/img/demo2.jpg" class="d-block w-100" data-interval="2000" alt="..." style="height: 224px; cursor:pointer">
                </div>
                <div class="carousel-item">
                    <img src="../assets/img/demo1.jpg" class="d-block w-100" data-interval="2000" alt="..." style="height: 224px; cursor:pointer">
                </div>
